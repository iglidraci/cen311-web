...
when the function that created them is no longer active? 
*/
const wrap = n => {
    let local = n;
    return () => local;
...
/*
even though winTrophies gets popped from the execution stack, winWorldCup still has access
