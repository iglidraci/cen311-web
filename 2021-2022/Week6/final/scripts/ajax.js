...
tableContainer.addEventListener('click', (event) => {
    ...
    if (year) {
        ...
        request.addEventListener('load', function() {
            ...
            standingContainer.querySelector('#title').textContent = jsonResult.data.name;
            standingContainer.querySelector('#season').textContent = jsonResult.data.seasonDisplay;
            const standings = jsonResult.data.standings;
